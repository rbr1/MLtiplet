...
#' @return doublet object (list of 1. the training doublet prediction table, 2. the doublet probabilities excluding the training doublets, 3. the doublet probabilities including the training doublets.
#' @export
Predict_doublets<-function(object ,marker_array, doublets_training, variables_norm, training_trim = 1){
  ...
  names(doublet_predictions) = c("prediction_table",  "doublet_probabilities_excluding_training","doublet_probabilities_including_training")
